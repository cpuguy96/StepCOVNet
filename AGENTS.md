...
| **DDCL / ITGPT recreation** (then incremental claims) | [PAPER_LEDGER.md](docs/research/PAPER_LEDGER.md) · [configs/ddc/ddcl_placement_fraxtil.json](configs/ddc/ddcl_placement_fraxtil.json) · `scripts/train_ddcl_placement.py` |
