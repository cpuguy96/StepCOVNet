...
| **DDCL / ITGPT recreation** (then incremental claims) | [PAPER_LEDGER.md](docs/research/PAPER_LEDGER.md) · [configs/ddc/ddcl_placement_fraxtil.json](configs/ddc/ddcl_placement_fraxtil.json) · [configs/ddc/itgpt_placement_fraxtil_exp.json](configs/ddc/itgpt_placement_fraxtil_exp.json) · `scripts/train_ddcl_placement.py` · `scripts/train_itgpt_placement.py` |
