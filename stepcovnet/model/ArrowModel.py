...
class ArrowModel(AbstractModel):
    def __init__(self, training_config: TrainingConfig, name: str = "StepCOVNetArrowModel"):
        ...
        model_output = self._create_arrow_model(arrow_input=arrow_input, arrow_mask=arrow_mask)
