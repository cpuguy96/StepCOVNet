...
| -- | ---- | ----- | ------------------- | ----- | --------- |
| D-frax-orig | Original Fraxtil | Tsunamix III; Fraxtil’s Arrow Arrangements; Fraxtil’s Beast Beats | **Measured 2026-08-15:** 90 songs, **463** chart rows (**450** standard + **13** edit). Paper table: 90 / 450 (`donahue2017ddc`) | `stratified_song_v1` seed 42, val_fraction 0.1 → **81 / 9** songs. Standard-only: `data/literature_fraxtil_orig/training_index_standard.json` (**405 / 45** rows). Not DDC’s unpublished 80/10/10 IDs | Recreate DDC, DDCL, and ITGPT-on-A. Ingest [EXP-20260815-01](EXPERIMENT_LOG.md#exp-20260815-01-original-fraxtil-dataset-a-ingested-90-songs); DDC 128-ep [EXP-20260815-03](EXPERIMENT_LOG.md#exp-20260815-03-ddc-128-ep-placement-closes-most-of-the-paper-gap); DDCL 128-ep [EXP-20260817-01](EXPERIMENT_LOG.md#exp-20260817-01-ddcl-48-slot-placement-128-ep-on-dataset-a); ITGPT 128-ep [EXP-20260819-03](EXPERIMENT_LOG.md#exp-20260819-03-itgpt-48-slot-placement-128-ep-on-dataset-a) |
| D-itg | In The Groove | ITG 1; ITG 2 | 133 songs, 652 charts | same rule | Multi-author DDC check |
| D-frax-exp | Expanded Fraxtil | D-frax-orig plus Cute Charts; Sweet Arrows and Hella Steps vols 1–3 (vol 4 **404** on fra.xtil.net) | Paper: 253 songs / 952 charts (`omalley2026itgpt`). **Measured 2026-08-18:** 232 raw folders, **222** exported songs / **747** chart rows (**722** standard + **25** edit). Ten SAHS songs skipped | `stratified_song_v1` seed 42, val_fraction 0.1 → **201 / 21** songs. Standard-only: `data/literature_fraxtil_exp/training_index_standard.json` (**653 / 69** rows). Not ITGPT’s unpublished split | Recreate ITGPT placement. Ingest [EXP-20260818-01](EXPERIMENT_LOG.md#exp-20260818-01-expanded-fraxtil-dataset-b-ingested); 8-ep [EXP-20260819-01](EXPERIMENT_LOG.md#exp-20260819-01-itgpt-paper-sized-placement-oom-then-mixed-fp16-8-ep-on-dataset-b); 128-ep [EXP-20260819-02](EXPERIMENT_LOG.md#exp-20260819-02-itgpt-48-slot-placement-128-ep-on-dataset-b) |
