...
| C7 | Recreated DDCL / ITGPT match published numbers on the matching corpus | hypothesis (ITGPT placement **Partial** — not vs Table 2) | Dataset B 128-ep last F1@0.5 **0.735** vs null **0.390** ([EXP-20260819-02](EXPERIMENT_LOG.md#exp-20260819-02-itgpt-48-slot-placement-128-ep-on-dataset-b)); corpus **222 / 747** vs paper **253 / 952**; 128 ep vs 200; mixed-fp16. DDCL Dataset A last **0.680** ([EXP-20260817-01](EXPERIMENT_LOG.md#exp-20260817-01-ddcl-48-slot-placement-128-ep-on-dataset-a)). Not a published-number match. | Results |
