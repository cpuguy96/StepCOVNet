...
| [AR_ONSET_DESIGN.md](AR_ONSET_DESIGN.md)                                   | **Autoregressive onset** — v1 stack locked 2026-06; Phase 0+1 in `onset_ar/`; **`gate-tide-overfit` failing** (§10.5, EXP-20260627-02) |
